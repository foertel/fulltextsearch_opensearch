...
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\BooleanRequestWrapper;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\NamespaceBuilderInterface;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\AsyncSearchNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\AsynchronousSearchNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\CatNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\ClusterNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\DanglingIndicesNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\DataFrameTransformDeprecatedNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\FlowFrameworkNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\GeospatialNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\IndicesNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\IngestNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\IngestionNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\InsightsNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\IsmNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\KnnNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\ListNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\LtrNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\MlNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\MonitoringNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\NeuralNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\NodesNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\NotificationsNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\ObservabilityNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\PplNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\QueryNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\RemoteStoreNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\ReplicationNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\RollupsNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\SearchPipelineNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\SearchRelevanceNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\SearchableSnapshotsNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\SecurityNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\SecurityAnalyticsNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\SmNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\SnapshotNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\SqlNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\SslNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\TasksNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\TransformsNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\UbiNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Namespaces\WlmNamespace;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Bulk;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\BulkStream;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\ClearScroll;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Count;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Create;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\CreatePit;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Delete;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\DeleteAllPits;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\DeleteByQuery;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\DeleteByQueryRethrottle;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\DeletePit;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\DeleteScript;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Exists;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\ExistsSource;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Explain;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\FieldCaps;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Get;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\GetAllPits;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\GetScript;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\GetScriptContext;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\GetScriptLanguages;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\GetSource;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Index;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Info;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\MTermVectors;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Mget;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Msearch;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\MsearchTemplate;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Ping;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\PutScript;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\RankEval;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Reindex;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\ReindexRethrottle;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\RenderSearchTemplate;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\ScriptsPainlessExecute;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Scroll;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Search;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\SearchShards;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\SearchTemplate;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\TermVectors;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Update;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\UpdateByQuery;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\UpdateByQueryRethrottle;
/**
 * Class Client
 *
...
class Client
{
     ...
     */
    public function __construct(TransportInterface|Transport $transport, callable|EndpointFactoryInterface|null $endpointFactory = null, array $registeredNamespaces = [])
    {
    ...
    public function create(array $params = [])
    {
        ...
        $index = $this->extractArgument($params, 'index');
        $body = $this->extractArgument($params, 'body');
        $endpoint = $id ? $this->endpointFactory->getEndpoint(Create::class) : $this->endpointFactory->getEndpoint(Index::class);
        $endpoint->setParams($params);
        $endpoint->setId($id);
        $endpoint->setIndex($index);
        $endpoint->setBody($body);
    ...
    {
        if (array_key_exists($arg, $params) === \true) {
            $value = $params[$arg];
    ...
    {
        return $this->httpTransport->sendRequest($endpoint->getMethod(), $endpoint->getURI(), $endpoint->getParams(), $endpoint->getBody(), $endpoint->getOptions());
    }
}
