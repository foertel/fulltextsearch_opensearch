...
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Exception\HttpExceptionFactory;
...
{
    public function __construct(protected ClientInterface $client, protected RequestFactoryInterface $requestFactory, protected SerializerInterface $serializer)
    {
    }
    /**
     ...
     * {@inheritdoc}
     */
    public function sendRequest(string $method, string $uri, array $params = [], mixed $body = null, array $headers = []): iterable|string|null
    {
