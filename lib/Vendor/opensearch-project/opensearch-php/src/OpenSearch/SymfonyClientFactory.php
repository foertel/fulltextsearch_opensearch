...
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\HttpClient\SymfonyHttpClientFactory;
...
class SymfonyClientFactory implements ClientFactoryInterface
{
    ...
    public function create(array $options): Client
    {
        ...
        $requestFactory = new RequestFactory($httpClient, $httpClient, $httpClient, $serializer);
        $transportFactory = (new TransportFactory())->setRequestFactory($requestFactory);
        if (isset($awsAuth)) {
