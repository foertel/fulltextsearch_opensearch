...
use OCA\FullTextSearch_OpenSearch\Vendor\Psr\Http\Message\RequestFactoryInterface as PsrRequestFactoryInterface;
...
{
    public function __construct(protected PsrRequestFactoryInterface $psrRequestFactory, protected StreamFactoryInterface $streamFactory, protected UriFactoryInterface $uriFactory, protected SerializerInterface $serializer)
    {
    }
    /**
     * {@inheritdoc}
     */
    public function createRequest(string $method, string $uri, array $params = [], string|array|null $body = null, array $headers = []): RequestInterface
    {
