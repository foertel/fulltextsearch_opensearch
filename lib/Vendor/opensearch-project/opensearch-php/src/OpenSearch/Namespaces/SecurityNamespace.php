...
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\Authinfo;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\Authtoken;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\Cache;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\ChangePassword;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\ConfigUpgradeCheck;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\ConfigUpgradePerform;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\CreateActionGroup;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\CreateAllowlist;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\CreateRole;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\CreateRoleMapping;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\CreateTenant;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\CreateUpdateTenancyConfig;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\CreateUser;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\CreateUserLegacy;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\DeleteActionGroup;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\DeleteDistinguishedName;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\DeleteRole;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\DeleteRoleMapping;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\DeleteTenant;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\DeleteUser;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\DeleteUserLegacy;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\FlushCache;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GenerateOboToken;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GenerateUserToken;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GenerateUserTokenLegacy;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetAccountDetails;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetActionGroup;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetActionGroups;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetAllCertificates;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetAllowlist;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetAuditConfiguration;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetCertificates;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetConfiguration;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetDashboardsInfo;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetDistinguishedName;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetDistinguishedNames;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetNodeCertificates;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetPermissionsInfo;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetRole;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetRoleMapping;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetRoleMappings;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetRoles;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetSslinfo;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetTenancyConfig;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetTenant;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetTenants;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetUser;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetUserLegacy;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetUsers;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\GetUsersLegacy;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\Health;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\Migrate;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\PatchActionGroup;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\PatchActionGroups;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\PatchAllowlist;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\PatchAuditConfiguration;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\PatchConfiguration;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\PatchDistinguishedName;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\PatchDistinguishedNames;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\PatchRole;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\PatchRoleMapping;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\PatchRoleMappings;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\PatchRoles;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\PatchTenant;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\PatchTenants;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\PatchUser;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\PatchUsers;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\PostDashboardsInfo;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\ReloadHttpCertificates;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\ReloadTransportCertificates;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\TenantInfo;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\UpdateAuditConfiguration;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\UpdateConfiguration;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\UpdateDistinguishedName;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\Validate;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\WhoAmI;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Security\WhoAmIProtected;
/**
...
class SecurityNamespace extends AbstractNamespace
{
    ...
    public function changePassword(array $params = [])
    {
        $body = $this->extractArgument($params, 'body');
        if ($body === null) {
            $body = ['current_password' => $this->extractArgument($params, 'current_password'), 'password' => $this->extractArgument($params, 'password')];
        }
    ...
    public function createActionGroup(array $params = [])
    {
        ...
        $body = $this->extractArgument($params, 'body');
        if ($body === null) {
            $body = ['allowed_actions' => $this->extractArgument($params, 'allowed_actions')];
        }
    ...
    public function createRoleMapping(array $params = [])
    {
        ...
        $body = $this->extractArgument($params, 'body');
        if ($body === null) {
            $body = array_filter(['backend_roles' => $this->extractArgument($params, 'backend_roles'), 'hosts' => $this->extractArgument($params, 'hosts'), 'users' => $this->extractArgument($params, 'users')]);
        }
    ...
    public function createRole(array $params = [])
    {
        ...
        $body = $this->extractArgument($params, 'body');
        if ($body === null) {
            $body = array_filter(['cluster_permissions' => $this->extractArgument($params, 'cluster_permissions'), 'index_permissions' => $this->extractArgument($params, 'index_permissions'), 'tenant_permissions' => $this->extractArgument($params, 'tenant_permissions')]);
        }
    ...
    public function createTenant(array $params = [])
    {
        ...
        $body = $this->extractArgument($params, 'body');
        if ($body === null) {
            $body = ['description' => $this->extractArgument($params, 'description')];
        }
    ...
    public function createUser(array $params = [])
    {
        ...
        $body = $this->extractArgument($params, 'body');
        if ($body === null) {
            $body = array_filter(['password' => $this->extractArgument($params, 'password'), 'opendistro_security_roles' => $this->extractArgument($params, 'opendistro_security_roles'), 'backend_roles' => $this->extractArgument($params, 'backend_roles'), 'attributes' => $this->extractArgument($params, 'attributes')]);
        }
