...
class DataFrameTransformDeprecatedNamespace extends AbstractNamespace
{
    ...
    public function deleteTransform(array $params = [])
    {
        ...
        $endpoint = $endpointBuilder('OCA\FullTextSearch_OpenSearch\Vendor\DataFrameTransformDeprecated\DeleteTransform');
    ...
    public function getTransform(array $params = [])
    {
        $transform_id = $this->extractArgument($params, 'transform_id');
        $endpointBuilder = $this->endpoints;
        $endpoint = $endpointBuilder('OCA\FullTextSearch_OpenSearch\Vendor\DataFrameTransformDeprecated\GetTransform');
        $endpoint->setParams($params);
        $endpoint->setTransformId($transform_id);
        return $this->performRequest($endpoint);
    }
    ...
    public function getTransformStats(array $params = [])
    {
        $transform_id = $this->extractArgument($params, 'transform_id');
        $endpointBuilder = $this->endpoints;
        $endpoint = $endpointBuilder('OCA\FullTextSearch_OpenSearch\Vendor\DataFrameTransformDeprecated\GetTransformStats');
        $endpoint->setParams($params);
        $endpoint->setTransformId($transform_id);
        return $this->performRequest($endpoint);
    }
    public function previewTransform(array $params = [])
    {
        ...
        $endpointBuilder = $this->endpoints;
        $endpoint = $endpointBuilder('OCA\FullTextSearch_OpenSearch\Vendor\DataFrameTransformDeprecated\PreviewTransform');
        $endpoint->setParams($params);
    ...
    public function putTransform(array $params = [])
    {
        ...
        $body = $this->extractArgument($params, 'body');
        $endpointBuilder = $this->endpoints;
        $endpoint = $endpointBuilder('OCA\FullTextSearch_OpenSearch\Vendor\DataFrameTransformDeprecated\PutTransform');
        $endpoint->setParams($params);
        $endpoint->setTransformId($transform_id);
        $endpoint->setBody($body);
        return $this->performRequest($endpoint);
    ...
    public function startTransform(array $params = [])
    {
        $transform_id = $this->extractArgument($params, 'transform_id');
        $endpointBuilder = $this->endpoints;
        $endpoint = $endpointBuilder('OCA\FullTextSearch_OpenSearch\Vendor\DataFrameTransformDeprecated\StartTransform');
        $endpoint->setParams($params);
        $endpoint->setTransformId($transform_id);
        return $this->performRequest($endpoint);
    }
    ...
    public function stopTransform(array $params = [])
    {
        $transform_id = $this->extractArgument($params, 'transform_id');
        $endpointBuilder = $this->endpoints;
        $endpoint = $endpointBuilder('OCA\FullTextSearch_OpenSearch\Vendor\DataFrameTransformDeprecated\StopTransform');
        $endpoint->setParams($params);
        $endpoint->setTransformId($transform_id);
        return $this->performRequest($endpoint);
    }
    ...
    public function updateTransform(array $params = [])
    {
        ...
        $body = $this->extractArgument($params, 'body');
        $endpointBuilder = $this->endpoints;
        $endpoint = $endpointBuilder('OCA\FullTextSearch_OpenSearch\Vendor\DataFrameTransformDeprecated\UpdateTransform');
        $endpoint->setParams($params);
        $endpoint->setTransformId($transform_id);
        $endpoint->setBody($body);
        return $this->performRequest($endpoint);
