...
class SearchableSnapshotsNamespace extends AbstractNamespace
{
    ...
    public function clearCache(array $params = [])
    {
        ...
        $endpoint = $endpointBuilder('OCA\FullTextSearch_OpenSearch\Vendor\SearchableSnapshots\ClearCache');
    ...
    public function mount(array $params = [])
    {
        ...
        $endpointBuilder = $this->endpoints;
        $endpoint = $endpointBuilder('OCA\FullTextSearch_OpenSearch\Vendor\SearchableSnapshots\Mount');
        $endpoint->setParams($params);
    ...
    public function repositoryStats(array $params = [])
    {
        $repository = $this->extractArgument($params, 'repository');
        $endpointBuilder = $this->endpoints;
        $endpoint = $endpointBuilder('OCA\FullTextSearch_OpenSearch\Vendor\SearchableSnapshots\RepositoryStats');
        $endpoint->setParams($params);
        $endpoint->setRepository($repository);
        return $this->performRequest($endpoint);
    }
    ...
    public function stats(array $params = [])
    {
        $index = $this->extractArgument($params, 'index');
        $endpointBuilder = $this->endpoints;
        $endpoint = $endpointBuilder('OCA\FullTextSearch_OpenSearch\Vendor\SearchableSnapshots\Stats');
        $endpoint->setParams($params);
        $endpoint->setIndex($index);
        return $this->performRequest($endpoint);
    }
