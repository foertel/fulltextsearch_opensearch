...
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Sql\Close;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Sql\Explain;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Sql\GetStats;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Sql\PostStats;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Sql\Query;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Sql\Settings;
/**
 * Class SqlNamespace
 *
...
class SqlNamespace extends AbstractNamespace
{
    ...
    {
        $endpoint = $this->endpointFactory->getEndpoint(Close::class);
        $endpoint->setBody(array_filter(['cursor' => $this->extractArgument($params, 'cursor')]));
        $endpoint->setParams($params);
        return $this->performRequest($endpoint);
    }
    /**
    ...
    public function explain(array $params): array
    {
        ...
        $endpoint->setBody(array_merge($body, ['query' => $query]));
        $endpoint->setParams($params);
        return $this->performRequest($endpoint);
    }
    /**
    ...
    public function query(array $params): array
    {
        ...
        $body = $this->extractArgument($params, 'body') ?? [];
        $endpoint->setBody(array_merge($body, array_filter(['query' => $this->extractArgument($params, 'query'), 'cursor' => $this->extractArgument($params, 'cursor'), 'fetch_size' => $this->extractArgument($params, 'fetch_size')])));
        $endpoint->setParams($params);
        return $this->performRequest($endpoint);
    }
}
