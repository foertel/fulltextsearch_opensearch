...
use OCA\FullTextSearch_OpenSearch\Vendor\Http\Discovery\Psr18ClientDiscovery;
...
class TransportFactory
{
    ...
    public function create(): HttpTransport
    {
        if ($this->requestFactory === null) {
            ...
            $this->requestFactory = new RequestFactory($psrRequestFactory, $streamFactory, $uriFactory, $serializer);
        }
