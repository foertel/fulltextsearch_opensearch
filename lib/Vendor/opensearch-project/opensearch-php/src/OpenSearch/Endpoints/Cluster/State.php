...
class State extends AbstractEndpoint
{
    ...
    {
        return ['allow_no_indices', 'cluster_manager_timeout', 'expand_wildcards', 'flat_settings', 'ignore_unavailable', 'local', 'master_timeout', 'wait_for_metadata_version', 'wait_for_timeout', 'pretty', 'human', 'error_trace', 'source', 'filter_path'];
    }
