 ...
 */
namespace OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Nodes;
...
class Stats extends AbstractEndpoint
{
    ...
    {
        return ['completion_fields', 'fielddata_fields', 'fields', 'groups', 'include_segment_file_sizes', 'level', 'timeout', 'types', 'pretty', 'human', 'error_trace', 'source', 'filter_path'];
    }
