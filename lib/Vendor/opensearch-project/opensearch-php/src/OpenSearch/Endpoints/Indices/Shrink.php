...
class Shrink extends AbstractEndpoint
{
    ...
    {
        return ['cluster_manager_timeout', 'copy_settings', 'master_timeout', 'task_execution_timeout', 'timeout', 'wait_for_active_shards', 'wait_for_completion', 'pretty', 'human', 'error_trace', 'source', 'filter_path'];
    }
