 ...
 */
namespace OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Tasks;
...
class Get extends AbstractEndpoint
{
    ...
    {
        return ['timeout', 'wait_for_completion', 'pretty', 'human', 'error_trace', 'source', 'filter_path'];
    }
