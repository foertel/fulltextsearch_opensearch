 ...
 */
namespace OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\DataFrameTransformDeprecated;
...
class StopTransform extends AbstractEndpoint
{
    ...
    {
        return ['wait_for_completion', 'timeout', 'allow_no_match'];
    }
