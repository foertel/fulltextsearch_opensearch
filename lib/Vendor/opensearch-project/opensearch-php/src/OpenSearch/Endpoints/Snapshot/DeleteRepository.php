 ...
 */
namespace OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Endpoints\Snapshot;
...
class DeleteRepository extends AbstractEndpoint
{
    ...
    {
        return ['cluster_manager_timeout', 'master_timeout', 'timeout', 'pretty', 'human', 'error_trace', 'source', 'filter_path'];
    }
