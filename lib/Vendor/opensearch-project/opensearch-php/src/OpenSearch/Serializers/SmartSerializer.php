 ...
 */
namespace OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Serializers;

use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Exception\JsonException;
...
class SmartSerializer implements SerializerInterface
{
    ...
    private function decode(?string $data): array
    {
        ...
        try {
            return json_decode($data, \true, 512, \JSON_THROW_ON_ERROR);
