...
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\Aws\SigningClientFactory;
use OCA\FullTextSearch_OpenSearch\Vendor\OpenSearch\HttpClient\GuzzleHttpClientFactory;
use OCA\FullTextSearch_OpenSearch\Vendor\Psr\Log\LoggerInterface;
use OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Psr7\HttpFactory;
...
{
    public function __construct(protected int $maxRetries = 0, protected ?LoggerInterface $logger = null, protected ?SigningClientFactory $awsSigningHttpClientFactory = null)
    {
    }
    /**
    ...
    public function create(array $options): Client
    {
        ...
        $transport = (new TransportFactory())->setHttpClient($httpClient)->setRequestFactory($requestFactory)->create();
