...
{
    public static function create(int $statusCode, string|array|null $data, array $headers = [], int $code = 0, ?\Throwable $previous = null): HttpExceptionInterface
    {
    ...
    private static function createBadRequestException(string $message = '', ?\Throwable $previous = null, int $code = 0, array $headers = []): HttpExceptionInterface
    {
     ...
     */
    private static function createInternalServerErrorException(string $message = '', ?\Throwable $previous = null, int $code = 0, array $headers = []): HttpExceptionInterface
    {
