...
use OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Ring\Exception\CancelledFutureAccessException;
...
trait BaseFutureTrait
{
     ...
     */
    public function __construct(PromiseInterface $promise, ?callable $wait = null, ?callable $cancel = null)
    {
