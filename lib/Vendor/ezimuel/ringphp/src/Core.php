...
namespace OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Ring;
...
use OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Ring\Future\FutureArray;
/**
...
class Core
{
     ...
     * @return FutureArray
     */
    public static function proxy(FutureArrayInterface $future, ?callable $onFulfilled = null, ?callable $onRejected = null, ?callable $onProgress = null)
    {
        return new FutureArray($future->then($onFulfilled, $onRejected, $onProgress), [$future, 'wait'], [$future, 'cancel']);
    }
    /**
