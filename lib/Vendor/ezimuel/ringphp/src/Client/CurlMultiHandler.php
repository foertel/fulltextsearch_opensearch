...
use OCA\FullTextSearch_OpenSearch\Vendor\React\Promise\Deferred;
/**
...
class CurlMultiHandler
{
    ...
    public function __invoke(array $request)
    {
        ...
        $entry = ['request' => $request, 'response' => [], 'handle' => $result[0], 'headers' => &$result[1], 'body' => $result[2], 'deferred' => new Deferred()];
        $id = (int) $result[0];
        $future = new FutureArray($entry['deferred']->promise(), [$this, 'execute'], function () use ($id) {
