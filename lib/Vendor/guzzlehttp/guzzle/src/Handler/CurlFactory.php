...
namespace OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Handler;

use OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Exception\ConnectException;
use OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Exception\RequestException;
use OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Promise as P;
use OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Promise\FulfilledPromise;
use OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Promise\PromiseInterface;
use OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Psr7\LazyOpenStream;
use OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\TransferStats;
use OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Utils;
use OCA\FullTextSearch_OpenSearch\Vendor\Psr\Http\Message\RequestInterface;
use OCA\FullTextSearch_OpenSearch\Vendor\Psr\Http\Message\UriInterface;
/**
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private static function createRejection(EasyHandle $easy, array $ctx): PromiseInterface
    {
        ...
        if ('' !== $sanitizedError) {
            $redactedUriString = \OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Psr7\Utils::redactUserInfo($uri)->__toString();
    ...
    private static function sanitizeCurlError(string $error, UriInterface $uri): string
    {
        ...
        $redactedUriString = \OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Psr7\Utils::redactUserInfo($baseUri)->__toString();
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf): void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Psr7\Utils::streamFor($sink);
