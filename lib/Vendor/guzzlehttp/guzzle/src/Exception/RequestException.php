...
namespace OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Exception;

use OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\BodySummarizer;
use OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\BodySummarizerInterface;
use OCA\FullTextSearch_OpenSearch\Vendor\Psr\Http\Client\RequestExceptionInterface;
...
class RequestException extends TransferException implements RequestExceptionInterface
{
    ...
    public static function create(RequestInterface $request, ?ResponseInterface $response = null, ?\Throwable $previous = null, array $handlerContext = [], ?BodySummarizerInterface $bodySummarizer = null): self
    {
        ...
        $uri = \OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Psr7\Utils::redactUserInfo($request->getUri());
