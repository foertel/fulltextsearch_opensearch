...
use OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Cookie\CookieJar;
use OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Exception\GuzzleException;
use OCA\FullTextSearch_OpenSearch\Vendor\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \OCA\FullTextSearch_OpenSearch\Vendor\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
