...
use OCA\FullTextSearch_OpenSearch\Vendor\Http\Discovery\Exception\PuliUnavailableException;
use OCA\FullTextSearch_OpenSearch\Vendor\Puli\Discovery\Api\Discovery;
use OCA\FullTextSearch_OpenSearch\Vendor\Puli\GeneratedPuliFactory;
/**
...
class PuliBetaStrategy implements DiscoveryStrategy
{
    ...
    private static function getPuliFactory()
    {
        if (null === self::$puliFactory) {
            if (!defined('OCA\FullTextSearch_OpenSearch\Vendor\PULI_FACTORY_CLASS')) {
