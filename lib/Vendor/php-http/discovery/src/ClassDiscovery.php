...
namespace OCA\FullTextSearch_OpenSearch\Vendor\Http\Discovery;

use OCA\FullTextSearch_OpenSearch\Vendor\Http\Discovery\Exception\ClassInstantiationFailedException;
use OCA\FullTextSearch_OpenSearch\Vendor\Http\Discovery\Exception\DiscoveryFailedException;
use OCA\FullTextSearch_OpenSearch\Vendor\Http\Discovery\Exception\NoCandidateFoundException;
use OCA\FullTextSearch_OpenSearch\Vendor\Http\Discovery\Exception\StrategyUnavailableException;
use OCA\FullTextSearch_OpenSearch\Vendor\Http\Discovery\Strategy\DiscoveryStrategy;
/**
