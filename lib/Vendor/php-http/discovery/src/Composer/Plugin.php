...
namespace OCA\FullTextSearch_OpenSearch\Vendor\Http\Discovery\Composer;

use OCA\FullTextSearch_OpenSearch\Vendor\Composer\Composer;
use OCA\FullTextSearch_OpenSearch\Vendor\Composer\DependencyResolver\Pool;
use OCA\FullTextSearch_OpenSearch\Vendor\Composer\EventDispatcher\EventSubscriberInterface;
use OCA\FullTextSearch_OpenSearch\Vendor\Composer\Factory;
use OCA\FullTextSearch_OpenSearch\Vendor\Composer\Installer;
use OCA\FullTextSearch_OpenSearch\Vendor\Composer\IO\IOInterface;
use OCA\FullTextSearch_OpenSearch\Vendor\Composer\Json\JsonFile;
use OCA\FullTextSearch_OpenSearch\Vendor\Composer\Json\JsonManipulator;
use OCA\FullTextSearch_OpenSearch\Vendor\Composer\Package\Locker;
use OCA\FullTextSearch_OpenSearch\Vendor\Composer\Package\Version\VersionParser;
use OCA\FullTextSearch_OpenSearch\Vendor\Composer\Package\Version\VersionSelector;
use OCA\FullTextSearch_OpenSearch\Vendor\Composer\Plugin\PluginInterface;
use OCA\FullTextSearch_OpenSearch\Vendor\Composer\Repository\InstalledRepositoryInterface;
use OCA\FullTextSearch_OpenSearch\Vendor\Composer\Repository\RepositorySet;
use OCA\FullTextSearch_OpenSearch\Vendor\Composer\Script\Event;
use OCA\FullTextSearch_OpenSearch\Vendor\Composer\Script\ScriptEvents;
use OCA\FullTextSearch_OpenSearch\Vendor\Composer\Util\Filesystem;
...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = ['php-http/async-client-implementation' => ['OCA\FullTextSearch_OpenSearch\Vendor\Http\Client\HttpAsyncClient'], 'php-http/client-implementation' => ['OCA\FullTextSearch_OpenSearch\Vendor\Http\Client\HttpClient'], 'psr/http-client-implementation' => ['OCA\FullTextSearch_OpenSearch\Vendor\Psr\Http\Client\ClientInterface'], 'psr/http-factory-implementation' => ['OCA\FullTextSearch_OpenSearch\Vendor\Psr\Http\Message\RequestFactoryInterface', 'OCA\FullTextSearch_OpenSearch\Vendor\Psr\Http\Message\ResponseFactoryInterface', 'OCA\FullTextSearch_OpenSearch\Vendor\Psr\Http\Message\ServerRequestFactoryInterface', 'OCA\FullTextSearch_OpenSearch\Vendor\Psr\Http\Message\StreamFactoryInterface', 'OCA\FullTextSearch_OpenSearch\Vendor\Psr\Http\Message\UploadedFileFactoryInterface', 'OCA\FullTextSearch_OpenSearch\Vendor\Psr\Http\Message\UriFactoryInterface']];
    ...
    public function getMissingRequires(InstalledRepositoryInterface $repo, array $requires, bool $isProject, array $pinnedAbstractions): array
    {
        ...
        if (ClassDiscovery::safeClassExists(\OCA\FullTextSearch_OpenSearch\Vendor\Phalcon\Http\Message\RequestFactory::class, \false)) {
